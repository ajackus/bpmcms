...
module.exports = {
  ...
  async register(ctx) {
    ...
    if (user && (typeof user.email === 'object' && user.email !== null) && user.provider === params.provider) {
      return ctx.badRequest(
        null,
        formatError({
    ...
    if(params.mobile_no) {
      ...
      if (user && !user.email && user.provider === params.provider) {
        return ctx.badRequest(
          null,
          formatError({
            id: 'Auth.form.error.mobile_no.taken',
